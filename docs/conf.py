...
# -*- coding: utf-8 -*-
#
# GrowthRatesPy documentation build configuration file, created by
...
project = 'GrowthRatesPy'
copyright = '2016, Yoav Ram'
author = 'Yoav Ram'
...
version = growthratespy.__version__
# The full version, including alpha/beta/rc tags.
release = growthratespy.__version__
...
htmlhelp_basename = 'GrowthRatesPydoc'
...
latex_documents = [
  (master_doc, 'GrowthRatesPy.tex', 'GrowthRatesPy Documentation',
   'Yoav Ram', 'manual'),
]
...
man_pages = [
    (master_doc, 'growthratespy', 'GrowthRatesPy Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'GrowthRatesPy', 'GrowthRatesPy Documentation',
   author, 'GrowthRatesPy', 'One line description of project.',
   'Miscellaneous'),
]
